...
class Player {
    ...
    public void playCard(int index, ParadeDeck paradeDeck) {
     ...
     */
    public void drawCard(GameEngine gameEngine) {
        if (!gameEngine.have6Colors(this)) { // players draw if they don't have 6 colors
            Card drawn = gameEngine.drawCard();
            hand.add(drawn);
        }
    }
